...
const OUTPUT_PATH = path.resolve(
	__dirname,
	'../play.pokemonshowdown.com/data/japanese-display-names.js'
);
const METADATA_PATH = path.resolve(
	__dirname,
	'../play.pokemonshowdown.com/data/japanese-display-names.meta.json'
);
...
function buildMetadata(tables) {
	return {
		...
		output: 'play.pokemonshowdown.com/data/japanese-display-names.js',
...
async function main() {
	...
	fs.writeFileSync(OUTPUT_PATH, renderDataset(tables));
